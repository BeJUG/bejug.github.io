...
We would love it if you drop us a message, either as a direct message https://www.meetup.com/belgian-java-user-group/[on Meetup.com] or though mail via mailto:belgian.jug@gmail.com[belgian.jug@gmail.com] if you are interested in hosting.
